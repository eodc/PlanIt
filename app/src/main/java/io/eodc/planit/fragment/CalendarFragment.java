...
public class CalendarFragment extends BaseFragment implements
    ...
    @BindView(R.id.calendar)              MaterialCalendarView  calendar;
    @BindView(R.id.rv_day_assignments)    RecyclerView          rvDaysAssignments;
    @BindView(R.id.layout_nothing_due)    LinearLayout          layoutNothingDue;
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == LOADER_CLASSES) return new CursorLoader(requireContext(), PlannerContract.ClassColumns.CONTENT_URI,
                    null, null, null, null);
