...
public class MainActivity extends AppCompatActivity{
    ...
    @BindView(R.id.bottom_navigation)   AHBottomNavigation      bottomNav;
    @BindView(R.id.create_fab)          FloatingActionButton    fab;
    @BindView(R.id.overlay)             ImageView               overlay;
    @BindView(R.id.toolbar)             Toolbar                 toolbar;

    @OnClick(R.id.create_fab) void handleBottomSheet() { if (!bottomSheetShown) showBottomSheet(); }
